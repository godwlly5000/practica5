...
vguardar.addEventListener('click', function() {
    //realizar la peticion HTTPS(POST mediante el API FETCH)
    fetch('http://localhost/app_web/servidor_V5/php/script_form_libros.php', {
            method: "POST",
            headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('http://localhost/app_web/servidor_V5/php/script_info_libros.php')
        .then(function(respuesta) {
            return respuesta.json();
        })
        .then(function(json) {
